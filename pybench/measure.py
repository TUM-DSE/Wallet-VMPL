...
class Bench(Generic[T], ContextDecorator):
    ...
    def __init__(self, tests: List[T], args_reboot: List[str] = [], brief: bool = False, extremes_only: bool = False):
        ...
        self.brief = brief
        self.extremes_only = extremes_only
        self.probe_peter()
